...
public class nuevoPreceptor {
	
	
	MySQLBD cc = new MySQLBD();
	
	public nuevoPreceptor(Preceptores doc,Nacionalidad n ,Domicilio d){
				...
				//INGERSO DOCENTE
				cc.ejecutar("INSERT INTO preceptores (DNI,legajo,turno) VALUES ("+doc.getDni()+",'"+doc.getLegajo()+"','"+doc.getTurno()+"')");
